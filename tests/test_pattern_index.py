...
from agents.pattern_index import InvertedPatternIndex
...
class TestPatternIndexPersistence:
    ...
    def test_load_from_constructor(self, temp_index_file):
        ...
        idx2 = InvertedPatternIndex(index_path=temp_index_file)
    ...
    def test_load_nonexistent_file(self):
        ...
        idx = InvertedPatternIndex(index_path="/nonexistent/path.json")
